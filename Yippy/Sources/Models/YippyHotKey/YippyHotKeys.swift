...
struct YippyHotKeys {
    ...
    static var ctrlAltLeftArrow = YippyHotKey(key: .leftArrow, modifiers: [.control, .option])
    static var ctrlAltRightArrow = YippyHotKey(key: .rightArrow, modifiers: [.control, .option])
    static var ctrlAltDownArrow = YippyHotKey(key: .downArrow, modifiers: [.control, .option])
    static var ctrlAltUpArrow = YippyHotKey(key: .upArrow, modifiers: [.control, .option])
